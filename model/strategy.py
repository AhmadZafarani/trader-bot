...
class ICHI_CROSS(Strategy):
    ...
    def check_open_con(self, i: int) -> bool:
        ...
        if i == 2:
            ...
            for i in range(id1 , id2+1):
                width.append(100 * abs(self.candles[i -1].leading_line1 - self.candles[i -1].leading_line2) / min(self.candles[i -1].leading_line1 , self.candles[i -1].leading_line2))
    ...
    def start_strategy(self):
        ...
        self.buy_volume = (self.dollar_balance /self.moment.price) * (scenario.volume_buy / 100)
        self.C = self.candles[self.moment.candle_id-1]
        self.ADX = [self.candles[self.moment.candle_id - 2].adx , self.candles[self.moment.candle_id - 1].DI_plus , self.candles[self.moment.candle_id - 1].DI_minus ]
        self.ICHI = [self.candles[self.moment.candle_id - 2].conversion_line , self.candles[self.moment.candle_id - 2].base_line]
        self.ICHHI = [self.candles[self.moment.candle_id - 3].conversion_line , self.candles[self.moment.candle_id - 3].base_line]
        self.buy_price = self.moment.price
        controller.buy(self.buy_volume, self.moment.price)
    ...
    def fin_and_before(self):
        ...
        self.ADXX = [self.candles[self.moment.candle_id - 2].adx , self.candles[self.moment.candle_id - 1].DI_plus , self.candles[self.moment.candle_id - 1].DI_minus ]
        self.ICHII = [self.candles[self.moment.candle_id - 2].conversion_line , self.candles[self.moment.candle_id - 2].base_line]
        self.ICHHII = [self.candles[self.moment.candle_id - 3].conversion_line , self.candles[self.moment.candle_id - 3].base_line]

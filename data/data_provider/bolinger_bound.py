...
length = int(input("enter lenght: "))  # usually 20
sdev = int(input("enter standard dev: "))  # usually 2
source = int(input("enter source: "))  # high or low or open or close

fd = pd.read_csv("BTC_FULL_1h-time.csv")
data0 = fd.values
data = []
...
with open('bollinger_bound.csv', 'w', newline='') as file:
